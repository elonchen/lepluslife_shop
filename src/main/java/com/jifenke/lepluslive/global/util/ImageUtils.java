...
public class ImageUtils {
   ...
   */
  public static BufferedImage watermark(File file, URL waterFileUrl, int x, int y, float alpha)
      throws IOException {
    // 获取底图
    BufferedImage buffImg = ImageIO.read(file);
    // 获取层图
    BufferedImage waterImg = ImageIO.read(waterFileUrl);
