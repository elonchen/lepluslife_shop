...
<section class="headBg">
    ...
    <div class="headHbEd" style="display: none;">
        <div class="hb-text">
            ...
            <p>获得<span id="A_status"><span id="scoreA">2.5</span>鼓励金和</span><span
                    id="scoreB">10</span>金币</p>
        </div>
                       ...
                       if (list != null) {
                           ...
                           for (var i = 0; i < length; i++) {
                               content +=
                                   ...
                                   + '<span style="font-size: 12px;">元</span><span style ="font-size: 11px;color: #AEAEAE;margin-left: 2%;text-decoration:line-through;">市场价'
