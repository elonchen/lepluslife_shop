...
<head>
    ...
    <!--标准mui.css-->
    <link rel="stylesheet" href="${commonResource}/css/mui.min.css">
    <link type="text/css" rel="stylesheet" href="${commonResource}/css/swiper-3.3.1.min.css">
    <!--App自定义的css-->
    <link rel="stylesheet" type="text/css"
          href="${resource}/product/productDetail/css/productDetail.css"/>
    <link rel="stylesheet" href="${resourceUrl}/frontRes/css/tanChuang.css">
    <script type="text/javascript" src="${commonResource}/js/swiper-3.3.1.min.js"></script>
    <script src="${commonResource}/js/jquery-2.0.3.min.js"></script>
                            ...
                            <p class="chose_right">
                                <c:forEach items="${product.productSpecs}" var="productSpec"
                                        ...
                                        <input
                                                ...
                                                value="${productSpec.minScore}"/></span>
...
<script type="text/javascript" src="${commonResource}/js/dropload.min.js"></script>
<script type="text/javascript" src="${resource}/product/productDetail/js/detail.js"></script>
