...
<section class="goodsList">
    <c:forEach items="${order.orderDetails}" var="orderDetail">
        <div>
            <div>
                <img src="${orderDetail.productSpec.picture}"
                     alt="">
            </div>
            <div>
                <div>
...
<section class="cost">
    ...
    <div>
        <div>总价</div>
        <div>￥<fmt:formatNumber type="number" value="${order.totalScore/100}" pattern="0.00"
                                maxFractionDigits="2"/>金币
        </div>
    </div>
</section>
<section class="integral">
    ...
    <div>
        <p>金币余额：<span><fmt:formatNumber type="number" value="${canUseScore/100}" pattern="0.00"
...
<script>
    ...
    $(".jfButton").click(function (e) {
        if (on) {//不使用金币
            ...
            on = false;
            $('#truePrice').html(toDecimal(orderTotalScore / 100));
            $('#scoreBwarning').show();
